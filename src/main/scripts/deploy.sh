...
docker run -dit --name potic-articles -e LOG_PATH=/logs -v /logs:/logs --link pocket-square-mongo -e MONGO_PASSWORD=$MONGO_PASSWORD -p 40402:8080 potic/potic-articles:$TAG_TO_DEPLOY
